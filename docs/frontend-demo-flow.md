...
- app has a generated GUID-format `client_id`
- API key is generated by GMS and shown once after creation
- API key is not shown again after the notice is closed
